...
import (
	context "context"
	externalversions "knstart/pkg/client/informers/externalversions"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knstart/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
