...
import (
	context "context"
	fmt "fmt"
	versionedscheme "knstart/pkg/client/clientset/versioned/scheme"
	client "knstart/pkg/client/injection/client"
...
const (
	defaultControllerAgentName = "knlearning-controller"
	defaultFinalizerName       = "knlearnings.xq2005.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := knlearningInformer.Lister()
